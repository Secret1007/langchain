    ...
    <Card className="shadow-lg">
      <CardContent className="space-y-4 p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <Input className="md:col-span-2" placeholder="Diary Title..." value={title} onChange={(e) => setTitle(e.target.value)} />
          <select value={category} onChange={(e) => setCategory(e.target.value)} className="border rounded-md p-2 w-full text-gray-700">
        ...
        <Textarea placeholder="Write your English diary here..." rows={12} value={content} onChange={(e) => setContent(e.target.value)} />
