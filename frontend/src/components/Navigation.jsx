  ...
  return (
    <nav className="flex justify-between items-center mb-8">
      ...
      <div className="space-x-6 text-gray-600 font-medium">
        <button className="hover:text-blue-500" onClick={() => setActiveTab("write")}>Home</button>
        <button className="hover:text-blue-500" onClick={() => setActiveTab("entries")}>Entries</button>
